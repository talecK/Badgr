...
describe GroupUser do
  ...
  it "should create an instance given valid attributes" do
    group_user = @user.group_users.build( @attr )
    group_user.save!
  end

  it "should require an admin flag" do
    group_user = @user.group_users.build( @attr.merge( :group_admin => nil ) )
  ...
  it "should be able to have its group admin status revoked" do
    group_user = @user.group_users.build( @attr.merge( :group_admin => true )  )
